...
/*
Owner - Kozlova Ksenia
Cube Name - Drivers for new classes
ID - 9DD32E4111EB7BFD47D50080EF157782
 */
...
with rd as
    (
    select
    distinct d.source_id driver_id,
...
--     count(distinct case when ordering_corporate_account_gk = 20004730 then order_gk end) orders_NF,
    ...
    and d.registration_date_key <= current_date - interval '30' day -- registered 30+ days ago
