...
LEFT JOIN "emilia_gettdwh"."dwh_dim_drivers_v" dd ON dd.source_id = j.supplier_id
...
WHERE
  j.env = 'RU'
  and date(j.scheduled_at) = date'2020-09-10'
  and ct.class_type_desc like '%ondemand%'
  and d.company_id <> '17459'
and j.legacy_order_id = 1350036520
and d.company_id = '25140'
